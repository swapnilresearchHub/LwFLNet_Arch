...
tl_checkpoint_1 = ModelCheckpoint(filepath='Train3DMAD_ValNUAACombinedCNNEpoch10.weights.best.hdf5',
                                  save_best_only=True,
                                  verbose=1)
# EarlyStopping
early_stop = EarlyStopping(monitor='loss',
...
merged_new_model.load_weights('Train3DMAD_ValNUAACombinedCNNEpoch10.weights.best.hdf5') # initialize the best trained weights
